...
export default function EmpleadoDetailScreen() {
  ...
  // 🟢 AQUÍ ESTÁ EL CAMBIO PRINCIPAL PARA LA FOTO
  const avatarImage = empleado.usuario?.foto_perfil
  ? { uri: empleado.usuario.foto_perfil }
  : require('../../../assets/images/fotoe1.jpg'); // Imagen default
