...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#FFF', borderRadius: BorderRadius.xxl, padding: Spacing.lg, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 10, elevation: 3, marginBottom: Spacing.lg },
  sectionTitle: { ...Typography.bodySmall, fontWeight: '900', color: Colors.primary, marginBottom: Spacing.lg, textTransform: 'uppercase', letterSpacing: 1 },
  selectorContainer: { marginBottom: Spacing.md },
  selectorLabel: { ...Typography.label, marginBottom: Spacing.xs, fontWeight: '700', opacity: 0.6 },
  selectorButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.03)', borderRadius: BorderRadius.lg, padding: Spacing.md, borderWidth: 1, borderColor: 'rgba(0,0,0,0.05)', gap: Spacing.sm },
  ...
  modalItem: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#FFF', padding: Spacing.lg, borderRadius: BorderRadius.xl, marginBottom: Spacing.sm },
  itemTitle: { fontSize: 16, fontWeight: '700' },
  itemSub: { fontSize: 12, opacity: 0.5 }
});
