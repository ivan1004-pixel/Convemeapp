...
export default function InsumoCreateScreen() {
  ...
  const validate = (): boolean => {
    ...
    if (!form.unidad_medida.trim()) newErrors.unidad_medida = 'REQUERIDO';
    if (form.stock_actual.trim() && isNaN(Number(form.stock_actual))) newErrors.stock_actual = 'NÚMERO INVÁLIDO';
    if (form.stock_minimo_alerta.trim() && isNaN(Number(form.stock_minimo_alerta))) newErrors.stock_minimo_alerta = 'NÚMERO INVÁLIDO';
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
                <View style={styles.card}>
                    ...
                    <Input
                        ...
                        leftIcon={<MaterialCommunityIcons name="package-variant" size={20} color={Colors.primary} />}
                    />
                    ...
                    <Input
                        ...
                        autoCapitalize="characters"
                        leftIcon={<MaterialCommunityIcons name="scale" size={20} color={Colors.primary} />}
                    />
